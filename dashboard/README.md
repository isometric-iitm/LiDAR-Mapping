...
<!--
![Grid 2.5D view](docs/assets/dashboard_grid.png)
![Training curves](docs/assets/dashboard_training.png)
-->
...
| `MetricsPanel` | `src/components/MetricsPanel.tsx` | Sidebar: stats grid, memory bars, view-mode selector, cell hover info |
...
```bash
# From pc2d/ root — starts both backend + dashboard
